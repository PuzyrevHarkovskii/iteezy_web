...
export function FirstCard() {
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-gray-50  relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1]  sm:w-[34rem] lg:w-[30em] lg:h-[30rem] h-auto rounded-[35px] p-6">
        <CardItem
          translateZ="50"
