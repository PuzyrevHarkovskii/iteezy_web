...
Как проходят занятия на курсах
          ...
          <ul> <h3>Преимущества курсов Progame:</h3>
          ...
          <ol> <h2>Программа курса:</h2>
            <li>- Свойства предметов</li>
            <li>- Сравнение, цифры, последовательность событий</li>
            <li>- Множества, кодирование, основы информатики</li>
            <li>- Комбинаторика, компьютерная грамотность</li>
          </ol>
        </div>
      </DragCloseDrawer>
    </div>
